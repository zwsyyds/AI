...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        String name = scoringResultAddRequest.getResultName().substring(0, 3);
        if(name.equals("ISTJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ISTJ.webp");
        if(name.equals("ISFJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ISFJ.webp");
        if(name.equals("INFJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/INFJ.webp");
        if(name.equals("ISTP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ISTP.webp");
        if(name.equals("ISFP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ISFP.webp");
        if(name.equals("INFP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/INFP.webp");
        if(name.equals("INTP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/INTP.webp");
        if(name.equals("ESTP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ESTP.webp");
        if(name.equals("ESFP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ESFP.webp");
        if(name.equals("ENFP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ENFP.webp");
        if(name.equals("ENTP"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ENTP.webp");
        if(name.equals("ESTJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ESTJ.webp");
        if(name.equals("ESFJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ESFJ.webp");
        if(name.equals("ENTJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ENTJ.webp");
        if(name.equals("ENFJ"))
            scoringResult.setResultPicture("https://zws-1318400414.cos.ap-guangzhou.myqcloud.com/app_icon/1876678407954743297/ENFJ.webp");
        // 数据校验
